...
namespace Nazca_Restaurant.Models
{
    ...
    public partial class sp_productosPorTipo_Result
    {
        ...
        public string chrCodTipo { get; set; }
        public Nullable<byte> bytHabilitado { get; set; }
        public Nullable<int> numStockD { get; set; }
